...
- Maintained by: Lailatul Coder
- Platform focus: Flutter mobile + FastAPI backend + AI model services
...
Please follow the community guidelines in [CODE_OF_CONDUCT.md](CODE_OF_CONDUCT.md).

---

### 🔒 Security

To report a vulnerability, please follow [SECURITY.md](SECURITY.md). Do not open public issues for sensitive security findings.
