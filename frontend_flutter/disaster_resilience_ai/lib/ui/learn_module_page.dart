...
final Map<String, _ModuleContent> _content = {
  'flood': _ModuleContent(
    ...
    heroSubtitle: 'Comprehensive guide to staying safe before, during and after a flood.',
    icon: Icons.water,
    color: const Color(0xFF1565C0),
    before: const _PhaseContent(title: 'Before a Flood', points: [
    ...
    during: const _PhaseContent(title: 'During a Flood', points: [
    ...
    after: const _PhaseContent(title: 'After a Flood', points: [
  ...
  'landslide': _ModuleContent(
    ...
    before: const _PhaseContent(title: 'Before a Landslide', points: [
    ...
    during: const _PhaseContent(title: 'During a Landslide', points: [
    ...
    after: const _PhaseContent(title: 'After a Landslide', points: [
  ...
  'earthquake': _ModuleContent(
    ...
    before: const _PhaseContent(title: 'Before an Earthquake', points: [
    ...
    during: const _PhaseContent(title: 'During an Earthquake', points: [
    ...
    after: const _PhaseContent(title: 'After an Earthquake', points: [
  ...
  'storm': _ModuleContent(
    ...
    before: const _PhaseContent(title: 'Before a Storm', points: [
    ...
    during: const _PhaseContent(title: 'During a Storm', points: [
    ...
    after: const _PhaseContent(title: 'After a Storm', points: [
  ...
  'tsunami': _ModuleContent(
    ...
    before: const _PhaseContent(title: 'Before a Tsunami', points: [
    ...
    during: const _PhaseContent(title: 'During a Tsunami', points: [
    ...
    after: const _PhaseContent(title: 'After a Tsunami', points: [
  ...
  'haze': _ModuleContent(
    ...
    before: const _PhaseContent(title: 'Before Haze Season', points: [
    ...
    during: const _PhaseContent(title: 'During Haze', points: [
    ...
    after: const _PhaseContent(title: 'After Haze Clears', points: [
...
class _LearnModulePageState extends State<LearnModulePage>
            ...
            children: [
              ...
              TabBar(
                ...
                unselectedLabelColor:
                    isDark ? const Color(0xFF9AA79B) : Colors.grey,
  ...
  Widget _buildPhaseTab(_PhaseContent phase, bool isDark) {
    ...
    final titleColor = isDark ? const Color(0xFFE5E7EB) : const Color(0xFF1E293B);
    final bodyColor = isDark ? const Color(0xFFCCD3CD) : const Color(0xFF374151);
  ...
  Widget _buildChatTab(bool isDark) {
    ...
    final hintColor = isDark ? const Color(0xFF6B7C6B) : const Color(0xFF94A3B8);
      ...
      child: Container(
        ...
        child: SizedBox(
          ...
          child: Row(
            ...
            children: List.generate(3, (i) => _Dot(delay: i * 150, color: _mod.color)),
          ),
        ),
      ),
    );
  ...
  Widget _buildSuggestions(bool isDark) {
    final chipBg = isDark
        ? _mod.color.withAlpha(30)
        : _mod.color.withAlpha(15);
